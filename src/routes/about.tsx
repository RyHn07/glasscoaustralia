        ...
        <div className="mx-auto max-w-[1280px] px-6">
          ...
          <ul className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {equipment.map((item, i) => (
              <li
                key={item}
                className="flex items-center gap-4 rounded-lg border border-neutral-200 bg-neutral-50 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-neutral-300 hover:shadow-lg"
              >
                <span
        ...
        <div className="relative mx-auto max-w-[1280px] px-6">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={title}
                className="group rounded-xl border border-neutral-200 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-neutral-300 hover:shadow-lg"
              >
                <div
